...
VALUES ('Tomatoes', 'Fresh, ripe tomatoes', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Mushrooms', 'Sliced mushrooms', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Pepperoni', 'Spicy Italian sausage',
        'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Green Peppers', 'Fresh, green bell peppers',
        'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Onions', 'Sweet, sliced onions', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Black Olives', 'Sliced black olives',
        'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Garlic', 'Minced garlic', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Italian Sausage', 'Ground Italian sausage',
        'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Bacon', 'Crispy bacon pieces', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Pineapple', 'Juicy pineapple chunks',
        'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Ham', 'Sliced ham', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ...
       ('Anchovies', 'Salty anchovy fillets',
        'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Basil', 'Fresh basil leaves', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Spinach', 'Fresh spinach leaves', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
       ('Chicken', 'Grilled chicken pieces', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/pngwing.com.png'),
...
VALUES ('Margherita', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/1.png',
       ...
       ('Supreme', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/1.png',
        ...
        4),
       ('BBQ Chicken', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/1.png',
        'A sweet and tangy pizza topped with BBQ sauce, mozzarella cheese, chicken, and red onions.', 5),
       ('Buffalo Chicken', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/1.png',
        'A spicy pizza topped with buffalo sauce, mozzarella cheese, chicken, and blue cheese.', 5),
       ('Margarita', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/1.png',
        'A refreshing pizza topped with tomato sauce, fresh mozzarella, and fresh basil.', 2),
       ('Four Cheese', 'https://artgallery-bucket.s3.eu-central-1.amazonaws.com/1.png',
